...
create: function(element, config) {
    ...
    element.innerHTML = `
          ...
          <div class="container" style="margin: auto;  position: absolute; top: 50%; transform: translateY(-50%); left: 50%; transformX(-50%);">
          ...
          <div class="header" style="margin: auto;  text-align: center;  color: rgba(58, 66, 69, 0.65);  font-size: 1rem; padding: 1rem;">footer.dimension thingymajigger</div>
    `;
